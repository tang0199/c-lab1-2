...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="Form1" runat="server">
		  <div>
			<div style="BORDER: thin ridge; PADDING: 20px; FONT-SIZE: x-small; FONT-FAMILY: Verdana; WIDTH: 293px; HEIGHT: 508px; BACKGROUND-COLOR: lightyellow">
			...
			<asp:panel ID="pnlCard" style="POSITION: absolute; LEFT: 355px; TOP: 16px" runat="server" Height="507px" Width="339px" HorizontalAlign="Center"><br />&nbsp; 
