...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form runat="server">
		  <div>
			<div style="BORDER: thin ridge; PADDING: 20px; FONT-SIZE: x-small;  WIDTH: 293px; FONT-FAMILY: Verdana; HEIGHT: 486px; BACKGROUND-COLOR: lightyellow">
			...
			<asp:panel ID="pnlCard" style="POSITION: absolute; LEFT: 350px; TOP: 16px" runat="server" Height="507px" Width="339px" HorizontalAlign="Center">
                <br />&nbsp; 
